...
print '<h2>' . $GLOBALS['I18N']->get('Importar correos electrónicos') . '</h2></br>';

print ' <div class="row">';

print ' <div class="col-xs-4 col-md-2 thbat"></div>';

print ' <div class="col-xs-4 col-md-3 thum"><a class="a" href="./?page=importsimple" ><img src="ui/phplist-ui-bootstrap/images/copy.svg" alt="phplist, import_copy" title="icon_copy"><div class="test">Copiar y pegar </br> lista de correos</div></a></div>';

print ' <div class="col-xs-4 col-md-2 thbat"></div>';

print ' <div class="col-xs-4 col-md-3 thum"><a class="a" href="./?page=import1" ><img src="ui/phplist-ui-bootstrap/images/texto.svg" alt="phplist, import_subirfichero" title="icon_subirfichero"><div class="test">Subir fichero </br>(Texto Plano)</div></a></div>';

print ' <div class="col-xs-4 col-md-2 thbat"></div>';

print ' <div class="col-xs-4 col-md-3 thum"><a class="a"href="./?page=import2"><img src="ui/phplist-ui-bootstrap/images/csv.svg" alt="phplist, import_csv" title="icon_csv"><div class="test">Importar </br> CSV</div></a></div>';
...
foreach ($GLOBALS['plugins'] as $pluginName => $plugin) {
    ...
    print '<hr>';
    print ' <h2>' . $GLOBALS['I18N']->get('Seleccione una opción') . '</h2>';
