<script>
      ...
      {
         $("#mostrarmodal").modal("hidde");
         $("#modalInvalid").modal("hidde");
         $("#modalOutput").modal("hidde");
         $("#modalWarring").modal("hidde");
         $("#modalOmit").modal("hidde");
         $("#modalOld").modal("hidde");
         $("#modalOverW").modal("hidde");
      });
    </script>   
...
print '<h2>' . $GLOBALS['I18N']->get('Importar correos electrónicos') . '</h2>';
...
<ul>
    ...
    */
    ...
    if ($some == 1) {
        ...
        print '<h2>' . s('Seleccione las listas a las que hay que añadir los correos') . '</h2>';
        /*
...
<div class="panel">
    <div class="content">
        ...
        <div class="row importcsvMain">
            <div class="col-xs-6 col-md-6">
                <div align="left"><?php echo $GLOBALS['I18N']->get('Archivo que contiene los emails:') ?>
                    <input type="file" name="import_file" text-align="center">
                    <a data-toggle="modal" href="#mostrarmodal" class="decoration">Tamaño máximo 5MB - Saber más</a>
                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p text-align="justify><?php printf($GLOBALS['I18N']->get('The following limits are set by your server:<br/>Maximum size of a total data sent to server: %s<br/>Maximum size of each individual file: %s'), ini_get('post_max_size'), ini_get('upload_max_filesize')); printf($GLOBALS['I18N']->get(' phpList will not process files larger than %dMB'), IMPORT_FILESIZE); ?></p>   
                                </div>
            ...
            <div class="col-xs-6 col-md-6">
                <div align="rigth" style="border: hidden"><?php echo $GLOBALS['I18N']->get('Delimitador de campos:') ?><input type="text" name="import_field_delimiter" size="5">
        ...
        <div class="row importcsvMain">
            <div class="col-xs-6 col-md-2">
                <div align="center"><?php echo $GLOBALS['I18N']->get('Assign Invalid') ?>:</br>
                    <a data-toggle="modal" href="#modalInvalid" class="decoration"> Saber más ...</a>
                </div>
            </div>

            <div class="col-xs-6 col-md-10">
                <div align="rigth"><input class="invalidInp" max-width="250px" type="text" name="assign_invalid" value="<?php echo $GLOBALS['assign_invalid_default'] ?>"/>
                </div>
                <div class="modal fade" id="modalInvalid" tabindex="-1" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p text-align="justify><?php echo $GLOBALS['I18N']->get('Assign Invalid will be used to create an email for subscribers with an invalid email address. You can use values between [ and ] to make up a value for the email. For example if your import file contains a column "First Name" and one called "Last Name", you can use "[first name] [last name]" to construct a new value for the email for this subscriber containing their first name and last name. The value [number] can be used to insert the sequence number for importing.') ?></p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                            </div>
        ...
        <div class="row importcsvMain">
            <div class="col-xs-6 col-md-4">
                <div align="rigth"><?php echo $GLOBALS['I18N']->get('Test output') ?>:<input type="checkbox" name="import_test" value="yes" checked="checked"/> </br>
                    <a data-toggle="modal" href="#modalOutput" class="decoration"> Saber más ...</a>
                </div>
                <div class="modal fade" id="modalOutput" tabindex="-1" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p text-align="justify><?php echo $GLOBALS['I18N']->get('If you check "Test Output", you will get the list of parsed emails on screen, and the database will not be filled with the information. This is useful to find out whether the format of your file is correct. It will only show the first 50 records.') ?></p>  
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                            </div>
            ...
            <div class="col-xs-6 col-md-4">
                <div align="center"><?php echo $GLOBALS['I18N']->get('Show Warnings') ?>: <input type="checkbox" name="show_warnings" value="yes"/> </br>
                        <a data-toggle="modal" href="#modalWarring" class="decoration"> Saber más ...</a>
                </div>
                <div class="modal fade" id="modalWarring" tabindex="-1" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            ...
                            <div class="modal-body">
                                <p text-align="justify><?php echo $GLOBALS['I18N']->get('If you check "Show Warnings", you will get warnings for invalid records. Warnings will only be shown if you check "Test Output". They will be ignored when actually importing. ') ?></p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                            </div>
            ...
            <div class="col-xs-6 col-md-4">
                <div align="rigth"><?php echo $GLOBALS['I18N']->get('Omit Invalid') ?>: <input type="checkbox" name="omit_invalid" value="yes"/> </br>
                    <a data-toggle="modal" href="#modalOmit" class="decoration"> Saber más ...</a>
                </div>
                <div class="modal fade" id="modalOmit" tabindex="-1" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            ...
                            <div class="modal-body">
                                <p text-align="justify"><?php echo $GLOBALS['I18N']->get('If you check "Omit Invalid", invalid records will not be added. Invalid records are records without an email. Any other attributes will be added automatically, ie if the country of a record is not found, it will be added to the list of countries.') ?></p>  
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                            </div>
        ...
        <div class="row importcsvMain">
            <div class="col-xs-6 col-md-6">
                <div align="left">
                    <?php echo $GLOBALS['I18N']->get('Retain Old User Email') ?>: <input type="checkbox" name="retainold" value="yes"/> </br>
                    <a data-toggle="modal" href="#modalOld" class="decoration"> Saber más ...</a>
                </div>
                <div class="modal fade" id="modalOld" tabindex="-1" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            ...
                            <div class="modal-body">
                                <p text-align="justify"><?php echo $GLOBALS['I18N']->get('If you check "Retain Old Email", a conflict of two emails being the same will keep the old one and add "duplicate" to the new one. If you don&quot;t check it, the old one will get "duplicate" and the new one will take precedence.') ?></p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                            </div>
            ...
            <div class="col-xs-6 col-md-6">
                <div align="left">
                    <?php echo $GLOBALS['I18N']->get('Overwrite Existing') ?>: <input type="checkbox" name="overwrite" value="yes" checked="checked"/> </br>
                    <a data-toggle="modal" href="#modalOverW" class="decoration"> Saber más ...</a>
                </div>
                <div class="modal fade" id="modalOverW" tabindex="-1" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            ...
                            <div class="modal-body">
                                <p text-align="justify"><?php echo $GLOBALS['I18N']->get('If you check "Overwrite Existing", information about a subscriber in the database will be replaced by the imported information. Subscribers are matched by email or foreign key.') ?></p>   
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                            </div>
...
<tr><td><?php echo $GLOBALS['I18N']->get('Notification throttle') ?>:</td><td><input type="text" name="throttle_import" size="5"> <?php echo $GLOBALS['I18N']->get('(default is nothing, will send as fast as it can)') ?></td></tr-->
        ...
        <div align="left">
            <input type="submit" name="import" value="<?php echo $GLOBALS['I18N']->get('Import') ?>">
        </div>
    </div>
</div>
</form>
